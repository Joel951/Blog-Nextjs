...
-- CreateIndex
CREATE UNIQUE INDEX "Like_userId_authorId_key" ON "Like"("userId", "authorId");
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "Articles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
